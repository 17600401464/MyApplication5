...
public class Myfadapter extends BaseAdapter {
	...
	Context con;
	public Myfadapter(Context activity,
	...
	public View getView(int arg0, View arg1, ViewGroup arg2) {
		...
		ViewHolder holder;
		if(arg1 ==null){
			arg1 = View.inflate(con, R.layout.adapter, null);
			holder = new ViewHolder();
			holder.txTitle = (TextView) arg1.findViewById(R.id.text_title);
			holder.txTime = (TextView) arg1.findViewById(R.id.text_duration);
	...
	class ViewHolder{
		private TextView txTitle,txTime,txArtist;
	}
	}
